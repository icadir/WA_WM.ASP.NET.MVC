    ...
    public class AdminController : BaseController
    {
        ...
        public async Task<JsonResult> SendCode(string id)
        {
            ...
            try
            {
                ...
                var body =
                    $"Merhaba <b>{user.Name} {user.Surname}</b><br>Hesabınızı aktif etmek için aşadıdaki linke tıklayınız<br> <a href='{SiteUrl}/account/activation?code={user.ActivationCode}' >Aktivasyon Linki </a> ";
        ...
        public async Task<ActionResult> EditUserAsync(UserProfileViewModel model)
        {
